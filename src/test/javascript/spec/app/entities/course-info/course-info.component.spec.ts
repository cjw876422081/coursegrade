...
import { CourseInfoComponent } from 'app/entities/course-info/course-info.component';
...
describe('Component Tests', () => {
  describe('CourseInfo Management Component', () => {
    let comp: CourseInfoComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(CourseInfoComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.courseInfos[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
