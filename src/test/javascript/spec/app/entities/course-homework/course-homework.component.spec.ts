...
import { CourseHomeworkComponent } from 'app/entities/course-homework/course-homework.component';
...
describe('Component Tests', () => {
  describe('CourseHomework Management Component', () => {
    let comp: CourseHomeworkComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(CourseHomeworkComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.courseHomeworks[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
