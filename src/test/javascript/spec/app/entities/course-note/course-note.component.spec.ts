...
import { CourseNoteComponent } from 'app/entities/course-note/course-note.component';
...
describe('Component Tests', () => {
  describe('CourseNote Management Component', () => {
    let comp: CourseNoteComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(CourseNoteComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.courseNotes[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
