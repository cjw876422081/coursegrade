...
export class StudentHomeworkComponent implements OnInit, OnDestroy {
  ...
  loadAll() {
    this.studentHomeworkService
      ...
      .subscribe(
        (res: HttpResponse<IStudentHomework[]>) => this.paginateStudentHomeworks(res.body, res.headers),
  ...
  protected paginateStudentHomeworks(data: IStudentHomework[], headers: HttpHeaders) {
    this.links = this.parseLinks.parse(headers.get('link'));
    this.totalItems = parseInt(headers.get('X-Total-Count'), 10);
    this.studentHomeworks = data;
  }
